...
# Deprecated: STEEM_* names are kept as aliases for backward compatibility in a Hive-only build
# Do not use in new code.
STEEM_100_PERCENT = HIVE_100_PERCENT
STEEM_1_PERCENT = HIVE_1_PERCENT
STEEM_REVERSE_AUCTION_WINDOW_SECONDS_HF21 = HIVE_REVERSE_AUCTION_WINDOW_SECONDS_HF21
STEEM_REVERSE_AUCTION_WINDOW_SECONDS_HF20 = HIVE_REVERSE_AUCTION_WINDOW_SECONDS_HF20
STEEM_REVERSE_AUCTION_WINDOW_SECONDS_HF6 = HIVE_REVERSE_AUCTION_WINDOW_SECONDS_HF6
STEEM_CONTENT_REWARD_PERCENT_HF16 = HIVE_CONTENT_REWARD_PERCENT_HF16
STEEM_CONTENT_REWARD_PERCENT_HF21 = HIVE_CONTENT_REWARD_PERCENT_HF21
STEEM_DOWNVOTE_POOL_PERCENT_HF21 = HIVE_DOWNVOTE_POOL_PERCENT_HF21
STEEM_VOTE_REGENERATION_SECONDS = HIVE_VOTE_REGENERATION_SECONDS
STEEM_VOTING_MANA_REGENERATION_SECONDS = HIVE_VOTING_MANA_REGENERATION_SECONDS
STEEM_VOTE_DUST_THRESHOLD = HIVE_VOTE_DUST_THRESHOLD
STEEM_ROOT_POST_PARENT = HIVE_ROOT_POST_PARENT
STEEM_RC_REGEN_TIME = HIVE_RC_REGEN_TIME
