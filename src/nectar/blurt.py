...
class Blurt(BlockChainInstance):
    """Hive-only build stub for legacy Blurt class.

    This project is Hive-only. Blurt support has been removed.
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            "Hive-only build: Blurt support has been removed. Use nectar.Hive instead."
        )
