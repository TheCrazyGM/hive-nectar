...
class Testcases(unittest.TestCase):
    ...
    def test_int(self):
        ...
        self.assertEqual(int(Amount(8.190, self.symbol)), 8190)
        ...
        self.assertEqual(int(Amount(amount=round(0.1509, 3), asset=Asset("HBD"))), 151)
    ...
    def test_float(self):
        ...
        self.assertEqual(float(Amount(0.151, self.symbol)), 0.151)
        self.assertEqual(float(Amount(round(0.1509, 3), self.symbol)), 0.151)
        self.assertEqual(float(Amount(8.190, self.symbol)), 8.190)
