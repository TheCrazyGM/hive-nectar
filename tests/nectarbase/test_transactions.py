...
class Testcases(unittest.TestCase):
    ...
    def test_Empty_Op(self):
        self.cm = (
            "f68585abf4dce7c8045700000120020c2218cd5bcbaf3bdaba2f192a7"
    ...
    def test_Transfer(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457010203666f6f046261617206b201000000"
    ...
    def test_create_account(self):
        ...
        self.cm = (
            "f68585abf4dce7c804570109102700000000000003535445454d000"
    ...
    def test_Transfer_to_vesting(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457010303666f6f046261617206b201000000"
    ...
    def test_withdraw_vesting(self):
        self.op = operations.Withdraw_vesting(
            **{"account": "foo", "vesting_shares": "100 VESTS", "prefix": default_prefix}
        )
    ...
    def test_Comment(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457010107666f6f6261726107666f6f626172620"
    ...
    def test_Vote(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457010007666f6f6261726107666f6f62617263"
    ...
    def test_Cancel_transfer_from_savings(self):
        self.op = operations.Cancel_transfer_from_savings(
            **{"from": "tesuser", "request_id": 9001, "prefix": default_prefix}
        )
    ...
    def test_order_create(self):
        ...
        self.cm = (
            "f68585abf4dce7c8045701050000000000000000000000000003535"
    ...
    def test_order_create2(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457011505616c696365bf850700010000000000000"
    ...
    def test_account_update(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457010a0973747265656d69616e01010000"
    ...
    def test_order_cancel(self):
        self.op = operations.Limit_order_cancel(
            **{"owner": "", "orderid": 2141244, "prefix": default_prefix}
        )

        self.cm = (
            "f68585abf4dce7c804570106003cac20000001206c9888d0c2c3"
    ...
    def test_set_route(self):
        ...
        self.cm = (
            "f68585abf4dce7c804570114057865726f63057865726f63e803"
    ...
    def test_convert(self):
        ...
        self.cm = (
            "f68585abf4dce7c804570108057865726f6343529d8ba0860100000"
    ...
    def test_utf8tests(self):
        ...
        self.cm = (
            "f68585abf4dce7c804570101000001610161012dec1f75303030307"
    ...
    def test_feed_publish(self):
        ...
        self.cm = (
            "f68585abf4dce7c804570107057865726f63e803000000000"
    ...
    def test_delete_comment(self):
        self.op = operations.Delete_comment(
            **{"author": "turbot", "permlink": "testpost", "prefix": default_prefix}
        )
    ...
    def test_witness_update(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457010b057865726f6308666f6f6f6f6261"
    ...
    def test_witness_set_properties(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457012a06696e69742d3102146163636f756e745f63726561746"
    ...
    def test_witness_vote(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457010c057865726f630a636"
    ...
    def test_witness_proxy(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457010d05616c69636503626f6"
    ...
    def test_custom(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457010f010a627974656d6173746572090384023"
    ...
    def test_custom_json(self):
        ...
        self.cm = (
            "f68585abf4dce7c8045701120001057865726f6306666f6c6c6f77795"
            "b227265626c6f67222c7b226163636f756e74223a227865726f63222c"
            "22617574686f72223a22636861696e7371756164222c227065726d6c6"
            "96e6b223a2273747265656d69616e2d636f6d2d746f2d6f70656e2d69"
            "74732d646f6f72732d616e642d6f666665722d612d32302d646973636"
            "f756e74227d5d0001205b20b05a472ce3831777e74e512f0c368dc7c0"
            "26a2a2e265002344be3589e57d1616bcac70192ba828bf0de4caa509a"
            "e0ddec5f0dae60b198151a6c49ee4753b"
        )
        self.doit()
    ...
    def test_comment_options(self):
        self.op = operations.Comment_options(
            **{
                ...
                "beneficiaries": [
                    {"weight": 2000, "account": "good-karma"},
                    {"weight": 5000, "account": "null"},
                ],
                "prefix": default_prefix,
            }
        )
    ...
    def test_change_recovery_account(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457011a066261727269650a626f6f6d6261"
    ...
    def test_request_account_recovery(self):
        self.op = operations.Request_account_recovery(
            **{
                ...
                "new_owner_authority": {
                    "weight_threshold": 1,
                    "account_auths": [],
                    "key_auths": [["STM6LYxj96zdypHYqgDdD6Nyh2NxerN3P1Mp3ddNm7gci63nfrSuZ", 1]],
                },
                "extensions": [],
                "prefix": default_prefix,
            }
        ...
        self.cm = (
            "f68585abf4dce7c80457011805737465656d05616c69636501000000000102"
    ...
    def test_recover_account(self):
        self.op = operations.Recover_account(
            **{
                ...
                "new_owner_authority": {
                    "weight_threshold": 1,
                    "account_auths": [],
                    "key_auths": [["STM7j3nhkhHTpXqLEvdx2yEGhQeeorTcxSV6WDL2DZGxwUxYGrHvh", 1]],
                },
                "recent_owner_authority": {
                    "weight_threshold": 1,
                    "account_auths": [],
                    "key_auths": [["STM78Xth94gNxp8nmByFV2vNAhg9bsSdviJ6fQXUTFikySLK3uTxC", 1]],
                },
                "extensions": [],
                "prefix": default_prefix,
            }
        ...
        self.cm = (
            "f68585abf4dce7c80457011905616c6963650100000000010375a6dfff76"
    ...
    def test_escrow_transfer(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457011b05616c69636503626f6207636861726c696"
    ...
    def test_escrow_dispute(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457011c05616c69636503626f6205616c696365e2"
    ...
    def test_escrow_release(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457011d05616c69636503626f6207636861726c6965"
    ...
    def test_escrow_approve(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457011f05616c69636503626f6207636861726c69"
    ...
    def test_decline_voting_rights(self):
        ...
        self.cm = (
            "f68585abf4dce7c804570124046a7564790100011f5bedbccb7042c5ab"
    ...
    def test_claim_reward_balance(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457012705616c696365110000000000000003535445454d00000"
    ...
    def test_delegate_vesting_shares(self):
        ...
        self.cm = (
            "f68585abf4dce7c80457012805616c69636503626f62e4d9c095095600000656455354530000000"
    ...
    def test_account_create_with_delegation(self):
        self.op = operations.Account_create_with_delegation(
            **{
                ...
                "owner": {
                    "weight_threshold": 1,
                    "account_auths": [],
                    "key_auths": [["STM5Tki3ecCdCCHCjhhwvQvXuKryL2s34Ma6CXsRzntSUTYVYxCQ9", 1]],
                },
                "active": {
                    "weight_threshold": 1,
                    "account_auths": [],
                    "key_auths": [["STM6LUoAA8gCL9tHRz7v9xcwR4ZWD3KDRHP5t1U7UAZHdfanLxyBE", 1]],
                },
                "posting": {
                    "weight_threshold": 1,
                    "account_auths": [],
                    "key_auths": [["STM8anmpHdfVE4AmwsDpcSXpRsydHysEbv6vGJkRQy1d1CC83zeTA", 1]],
                },
        ...
        self.cm = (
            "f68585abf4dce7c804570129b80b00000000000003535445454d00000000000"
