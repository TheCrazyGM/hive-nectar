...
class Testcases(unittest.TestCase):
    def test_btc_privkey(self):
        ...
        self.assertEqual(
            ...
            "029dc2912196f2ad7a830747c2490287e4ff3ea52c417598681a955dcdf473b6c0",
        )
        self.assertEqual(
    ...
    def test_with_sec(self):
        ...
        self.assertEqual(
            key.ExtendedKey(),
            "xprv9s21ZrQH143K3EGRfjQYhZ6fA3HPPiw6rxopHKXfWTrB66evM4fDRiUScJy5RCCGz98nBaCCtwpwFCTDiFG5tx3mdnyyL1MbHmQQ19BWemo",
        )
        m = key
